		...
		<div class="container mx-auto max-w-5xl flex flex-col justify-between items-center relative font-mono">
			<div class="flex flex-col px-6 py-40">
				...
				<div class="flex items-center justify-center mt-4 uppercase">
					<a href="https://github.com/moneymafia" class="py-2 my-2 px-5 md:mt-16 bg-transparent dark:text-gray-800 dark:bg-white hover:dark:bg-gray-100 border-2 border-gray-800 text-gray-800 dark:text-white hover:bg-gray-800 hover:text-white text-md"> GITHUB </a>
